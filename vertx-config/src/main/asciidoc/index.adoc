...
configures a set of configuration stores
...
----
If ssl conntection is required, trust relations must be established.

==== Usage of JKSTruststore 
[source, $lang]
----
http.put("trustStoreOptions", new JsonObject().put("path",path).put("password",password))
----

==== Usage of PfxTrustore
[source, $lang]
----
http.put("pfxTrustOptions", new JsonObject().put("path",path).put("password",password))
----

==== Trust all
[source, $lang]
----
http.put("trustAll", true)
----
=== Event Bus
